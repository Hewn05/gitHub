...
<body>
	...
	<form action = "RequestInfo.jsp" method = "post">
		...
		English : <input type = "text" name = "kor" value = "잘 자."/>
	...
	<form method = "post" action = "RequestParam.jsp">
		...
		성별	 : <input type = 'radio' name = 'gender' value = 'woman' checked = 'checked'/>여자<br/>
		성별	 : <input type = 'radio' name = 'gender' value = 'man'/>남자<br/>
		관심사항 : <input type = 'checkbox' name = 'inter' value = 'movie' checked = 'checked'> 영화
